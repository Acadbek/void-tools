      ...
      {!image ? (
        ...
        >
          ...
          <div className="flex flex-col items-center gap-4">
            <div className="p-5 bg-indigo-100 text-indigo-600 rounded-full">
              <Upload className="w-10 h-10" />
            </div>
            <div>
              <p className="text-xl font-bold text-gray-700">Upload Image to Resize</p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          {/* LEFT: PREVIEW */}
          <div className="bg-gray-100 rounded-xl p-4 flex items-center justify-center border border-gray-200 min-h-[400px]">
          ...
          <div className="bg-white p-6 rounded-xl border border-gray-100 shadow-sm space-y-6">
            <div className="flex justify-between items-center border-b pb-4">
              <h3 className="font-bold text-gray-800">Resize Options</h3>
              <button onClick={reset} className="text-sm text-red-500 hover:text-red-600 flex items-center gap-1">
            ...
            <div className="space-y-4">
              <div className="flex items-end gap-2">
                ...
                <button
                  ...
                  className={`mb-1 p-2 rounded-lg border transition-colors ${maintainAspectRatio ? 'bg-indigo-100 text-indigo-600 border-indigo-200' : 'bg-gray-100 text-gray-400 border-gray-200'}`}
              ...
              <div className="flex flex-wrap gap-2 mt-2">
                {[0.25, 0.5, 0.75].map((scale) => (
                  <button
                    ...
                    className="text-xs bg-gray-50 hover:bg-gray-100 border border-gray-200 px-3 py-1 rounded-md text-gray-600"
                  >
                    {scale * 100}%
                  </button>
                ))}
            ...
            <button
              ...
              className={`w-full py-4 rounded-xl font-bold text-lg text-white flex items-center justify-center gap-2 transition-all shadow-md
                ${isProcessing ? 'bg-indigo-400' : 'bg-indigo-600 hover:bg-indigo-700 hover:-translate-y-1 hover:shadow-lg'}
              `}
            >
              {isProcessing ? (
                <>Processing...</>
