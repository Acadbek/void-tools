        ...
        <div className="flex flex-col lg:flex-row gap-6 h-[calc(100vh-140px)] min-h-[600px]">
            ...
            <div className="w-full lg:w-[400px] flex flex-col bg-white border border-gray-200 rounded-xl shadow-sm overflow-hidden flex-shrink-0">
                ...
                <div className="p-5 space-y-6 flex-1">
                    <div>
                        <label className="text-xs font-bold text-gray-500 uppercase mb-2 block">Video Topic</label>
                        <input
                            type="text"
                            value={topic}
                            ...
                            className="w-full px-4 py-3 border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all font-medium"
                            autoFocus
                        />
                        <p className="text-xs text-gray-400 mt-2">Enter your keyword to generate content.</p>
                    </div>

                    <div>
                        <label className="text-xs font-bold text-gray-500 uppercase mb-2 block">Content Style</label>
            ...
            <div className="flex-1 flex flex-col min-w-0 bg-white border border-gray-200 rounded-xl shadow-sm overflow-hidden">
                ...
                <div className="flex-1 bg-gray-50/50 p-4 overflow-y-auto custom-scrollbar">
                    {results.length === 0 ? (
                        ...
                        <div className="space-y-4">
                            {results.map((item) => (
                                <div
                                    key={item.id}
                                    className="group bg-white p-5 rounded-xl border border-gray-200 shadow-sm hover:shadow-md hover:border-blue-300 transition-all animate-in slide-in-from-bottom-2 duration-300"
                                >
                                    <div className="flex items-start justify-between gap-4">
                                        {/* Content */}
                                        <div className="flex-1 space-y-2">
                                            {/* Title */}
                                            <h4 className="font-bold text-gray-900 text-lg leading-snug group-hover:text-blue-700 transition-colors">
                                                {item.title}
                                            </h4>
                                    ...
                                    `}>
                                                ...
                                                <span className="text-[10px] font-medium text-gray-400 capitalize flex items-center gap-1">
                                 ...
                                 ${copiedId === item.id
                                                    ...
                                                    : 'bg-gray-50 border-gray-200 text-gray-400 hover:text-blue-600 hover:bg-blue-50 hover:border-blue-200'
                                                }
                               `}
                                            title="Copy Title"
                                        >
