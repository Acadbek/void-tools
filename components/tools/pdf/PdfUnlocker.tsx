    ...
    return (
        <div className="flex flex-col h-full gap-6">
            ...
            <div className="bg-blue-50 border border-blue-100 p-4 rounded-xl flex items-start gap-3">
                ...
                <div>
                    <h3 className="font-semibold text-gray-800 text-sm">Remove PDF Password</h3>
                    <p className="text-xs text-gray-600 mt-1">
                        Permanently remove security from your PDF.
                        <span className="font-semibold text-blue-600"> You must know the current password</span> to unlock it.
                    </p>
                </div>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-6 h-full">
             ...
             `}
                        >
                            ...
                            {file ? (
                                ...
                                <div className="text-center">
                                    ...
                                    <p className="font-medium text-gray-700">Drop PDF here</p>
                                    <p className="text-xs text-gray-400 mt-2">Only encrypted files supported</p>
                                </div>
                            )}
                        </div>
                    ) : (
                ...
                {/* RIGHT: ACTION AREA */}
                <div className="flex flex-col justify-center gap-6 bg-gray-50 p-6 rounded-xl border border-gray-100">
                    ...
                    {file && !isEncrypted && !error && (
                        <div className="flex flex-col items-center text-gray-500 text-center">
                            ...
                            <h4 className="font-medium text-gray-800">No Password Needed</h4>
                    ...
                    {file && isEncrypted && !isUnlocked && (
                        <div className="space-y-4 animate-in slide-in-from-bottom-2">
                            <div className="text-center mb-2">
                                <h4 className="font-bold text-gray-800 text-lg">Enter Password</h4>
                                <p className="text-sm text-gray-500">Enter the document password to decrypt it.</p>
                            </div>
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    className={`w-full pl-10 pr-10 py-3 rounded-lg border focus:ring-2 focus:ring-blue-500 outline-none transition-all ${error ? 'border-red-300 focus:ring-red-200' : 'border-gray-200'}`}
                            ...
                            <button
                                ...
                                className="w-full bg-blue-600 text-white py-3 rounded-lg font-bold hover:bg-blue-700 transition-all shadow-md flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
                            >
                                {isProcessing ? (
